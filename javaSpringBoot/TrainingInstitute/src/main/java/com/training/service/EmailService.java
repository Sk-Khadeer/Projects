...
//		hhmnhtfcskczulik -------------- MAIL PWD
		...
		try {
			...
			courseBodyContent += "<div style='margin-top: 10px;'>AK Trainee Institute Campus</div>"; // Caption below the image																										
			...
			DataSource source = new FileDataSource("C://Users//user181//Documents//images//AK.png"); // Replace with the actual image path																							
